...
class TopicFilter extends StatefulWidget {
  ...
  const TopicFilter({Key? key, required this.onApplyFilter}) : super(key: key);
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              _showBottomSheet('Loại hình', ['Đề tài','Nhiệm vụ'], (value) {
                                setState(() {
                          ...
                          GestureDetector(
                            onTap: () {
                              _showBottomSheet('Cấp quản lý', ['Cấp học viện', 'Cấp trung tâm'], (value) {
                                setState(() {
