...
class StaffUpdateResponse {
  ...
  StaffUpdateResponse.fromJson(dynamic json) {
    _employee = json['employee'] != null ? Employee.fromJson(json['employee']) : null;
    _error = json['error'];
  }
  Employee? _employee;
  dynamic _error;
StaffUpdateResponse copyWith({  Employee? employee,
  dynamic error,
}) => StaffUpdateResponse(  employee: employee ?? _employee,
  error: error ?? _error,
);
