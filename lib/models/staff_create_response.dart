...
class StaffCreateResponse {
  ...
  StaffCreateResponse.fromJson(dynamic json) {
    _employee = json['employee'] != null ? Employee.fromJson(json['employee']) : null;
    _error = json['error'];
  }
  Employee? _employee;
  dynamic _error;
StaffCreateResponse copyWith({  Employee? employee,
  dynamic error,
}) => StaffCreateResponse(  employee: employee ?? _employee,
  error: error ?? _error,
);
